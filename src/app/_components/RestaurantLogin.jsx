...
const RestaurantLogin = () => {
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-100">
      <div className="p-8 flex flex-col justify-center items-center gap-6 bg-white rounded-lg shadow-lg w-full sm:w-96">
        <h3 className="text-3xl font-semibold text-gray-800">Login</h3>
        <form className="flex flex-col gap-4 w-full">
          <input
            type="email"
            placeholder="Email"
            className="p-3 rounded-md border border-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
          <input
            type="password"
